...
(() => {
  ...
  // icon: {sheet: tilesetKey, tile: index} drawn from the real sliced tilesets.
  SSG.ITEMS = {
    ...
    'Mushroom Cap':  {type:'material', icon:{sheet:'meadow', tile:6},  sell:3,  desc:'Bouncy meadow mushroom cap.'},
    'Flower':        {type:'material', icon:{sheet:'meadow', tile:14}, sell:3,  desc:'Bright meadow flower.'},
    'Crystal Shard': {type:'material', icon:{sheet:'birthday', tile:21}, sell:8,  desc:'Glowing shard from Crystal Cave.'},
    ...
    'Moon Herb':     {type:'material', icon:{sheet:'moon', tile:3},   sell:10, desc:'Herb that only blooms in moonlight.'},
    'Ancient Relic': {type:'material', icon:{sheet:'ruins', tile:4},  sell:14, desc:'Golden dial from the Ancient Ruins.'},

    'Berry Juice':   {type:'consumable', icon:{sheet:'meadow', tile:18}, sell:6,  heal:45,  desc:'Restores 45 HP.'},
    'Crystal Candy': {type:'consumable', icon:{sheet:'birthday', tile:21}, sell:8, mana:20, desc:'Restores 20 MP.'},
    'Mushroom Stew': {type:'consumable', icon:{sheet:'meadow', tile:7},  sell:14, heal:120, desc:'Hearty stew. Restores 120 HP.'},
    'Moon Tea':      {type:'consumable', icon:{sheet:'moon', tile:6},   sell:16, mana:999, desc:'Restores all MP. Haraku loves it.'},
    ...
    'Crystal Sword +1':{type:'equipment', slot:'weapon', icon:{sheet:'cave', tile:8},  sell:30, attack:6,  desc:'Sharpened hero blade. +6 ATK.'},
    'Gear Blade':    {type:'equipment', slot:'weapon', icon:{sheet:'petro', tile:11}, sell:60, attack:12, desc:'Petro-forged edge. +12 ATK.'},
    'Starfall Edge': {type:'equipment', slot:'weapon', icon:{sheet:'moon', tile:16},  sell:110, attack:20, desc:'Blade of captured starlight. +20 ATK.'},
    'Guardian Plate':{type:'equipment', slot:'armor',  icon:{sheet:'ruins', tile:3},  sell:55, defense:8, desc:'Stone-set armor. +8 DEF.'},
    'Moonweave Cloak':{type:'equipment', slot:'armor', icon:{sheet:'moon', tile:9},   sell:90, defense:14, desc:'Woven moonlight. +14 DEF.'},
    'Gadget Charm':  {type:'equipment', slot:'charm',  icon:{sheet:'petro', tile:4},  sell:40, maxMp:15, desc:'Dave-made charm. +15 max MP.'},
    'Moon Charm':    {type:'equipment', slot:'charm',  icon:{sheet:'moon', tile:5},   sell:60, maxMp:25, desc:'Shrine token. +25 max MP.'},
    'Relic Crown':   {type:'equipment', slot:'charm',  icon:{sheet:'ruins', tile:9},  sell:140, attack:5, defense:5, maxMp:20, desc:'Crown of the old kings. +5 ATK, +5 DEF, +20 MP.'}
  };
