...
const entries = ['assets', 'data', 'docs', 'js', 'game.js', 'ads.js', 'site.js', 'styles.css', 'favicon.ico', 'robots.txt', 'sitemap.xml', 'llms.txt', 'ai-summary.json', 'site.webmanifest', 'humans.txt', 'security.txt', '_headers', '_redirects'];
