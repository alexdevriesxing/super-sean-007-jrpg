...
try {
  ...
  if (facts.version !== '1.4.0') errors.push(`Expected release 1.4.0, found ${facts.version}.`);
...
if (!health.includes("version: '1.4.0'")) errors.push('Health endpoint does not report version 1.4.0.');
...
console.log('Version 1.4.0 validation passed: production-only assets, automated deployment, public status, live monitoring and commercial release protections.');
