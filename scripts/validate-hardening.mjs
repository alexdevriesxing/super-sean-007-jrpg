...
try {
  ...
  if (facts.version !== '1.3.3') errors.push(`Expected release 1.3.3, found ${facts.version}.`);
...
if (!health.includes("version: '1.3.3'")) errors.push('Health endpoint does not report version 1.3.3.');
...
console.log('Version 1.3.3 validation passed: production-only assets, automated deployment, public status, live monitoring and commercial release protections.');
