...
try {
  ...
  if (facts.version !== '1.3.2') errors.push(`Expected release 1.3.2, found ${facts.version}.`);
...
if (!health.includes("version: '1.3.2'")) errors.push('Health endpoint does not report version 1.3.2.');
...
console.log('Version 1.3.2 validation passed: production-only assets, automated deployment, public status, live monitoring and commercial release protections.');
